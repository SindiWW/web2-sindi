  ...
  <div class="container-fluid">
    ...
    <section class="py-5 mt-5">
      <div class="container text-center">
        <h2 class="fw-bold">Organisasi <span style="color:#2563eb;">Siswa</span></h2>
        <div class="row mt-4">
          
          <!-- Card 1 -->
          <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100 text-center p-3 border-0">
              <img src="img/mpk.png" class="mx-auto d-block img-fluid" style="height:150px;" alt="MPK">
              <div class="card-body">
                <h5 class="card-title fw-semibold">MPK</h5>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100 text-center p-3 border-0">
              <img src="img/osis.png" class="mx-auto d-block img-fluid" style="height:150px;" alt="OSIS">
              <div class="card-body">
                <h5 class="card-title fw-semibold">OSIS</h5>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100 text-center p-3 border-0">
              <img src="img/pub.png" class="mx-auto d-block img-fluid" style="height:150px;" alt="PUB">
              <div class="card-body">
                <h5 class="card-title fw-semibold">PUB</h5>
              </div>
            </div>
          </div>
