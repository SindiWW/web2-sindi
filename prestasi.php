...
<section class="py-5" style="background-color:#f9fafb;">
  ...
  <div class="col-md-4">
    <div class="card border-0 rounded-3 custom-blue">
      <img src="img/juara 1.jpg" class="card-img-top img-fluid rounded-3" alt="prestasi 1 style="object-fit: cover; height: 250px;">
    <div class="card-body p-4">
            <h5 class="fw-bold mb-3 text-center">Juara 1</h5>
            <p class="text-muted mb-0">
              LKS Otomotif Tingkat Kota Tasikmalaya Bidang Lomba Motorcycle Repair & Maintenance
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="col-md-4">
    <div class="card border-0 rounded-3 custom-blue">
      <img src="img/juara 2.jpg" class="card-img-top img-fluid rounded-3" alt="prestasi 2 style="object-fit: cover; height: 250px;">
    <div class="card-body p-4">
            <h5 class="fw-bold mb-3 text-center">Juara 2</h5>
            <p class="text-muted mb-0">
  ...
  <div class="col-md-4">
    <div class="card border-0 rounded-3 custom-blue">
      <img src="img/juara 3.jpg" class="card-img-top img-fluid rounded-3" alt="prestasi 3 style="object-fit: cover; height: 250px;">
    <div class="card-body p-4">
            <h5 class="fw-bold mb-3 text-center">Juara 3</h5>
            <p class="text-muted mb-0">
