...
<section class="ekskul-section py-5">
  <div class="container text-center text-white">
    <h2 class="ekskul-title fw-bold mb-4">Ekstrakurikuler</h2>
      ...
      foreach ($ekskul as $e): ?>
        <div class="col-6 col-md-4 col-lg-2">
          <div class="card h-100 text-center shadow-sm border-0">
            <div class="card-body">
              <img src="<?= $e['img'] ?>" class="img-fluid mb-2" alt="<?= $e['nama'] ?>" style="max-height:120px;">
              <h6 class="fw-bold text-dark"><?= $e['nama'] ?></h6>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
