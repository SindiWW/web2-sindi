...
<html lang="en">
 ...
 <div class="container section-wrapper">
    ...
    <div class="mb-5 text-center">
      <img src="img/sejarahsmkn4.jpg" alt="Gerbang Sekolah" class="img-fluid rounded-3 shadow-sm">
    </div>

    <!-- Latar Belakang -->
    <div class="card shadow-sm section-box mb-4 text-center">
      <div class="card-body">
        <h5 class="fw-bold mb-3">SEJARAH SMKN 4 TASIKMALAYA</h5>
        <p>
          SMK NEGERI 4 Tasikmalaya memiliki sejarah panjang sejak era kolonial Belanda. Berikut ini rangkumannya:
